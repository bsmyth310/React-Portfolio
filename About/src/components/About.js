...
function About() {
    return (
        <div>
            <p className="content is-medium">Autodidact Jack of all Trades Master of None, Hopeful Full MERN Stack Developer</p>
            <hr />
            <img className="my-pic" src="./assets/profile.jpg" alt="Benjamin Smyth"/>
